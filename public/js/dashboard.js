...
function wrdashboad(imp) {
  ...
  <div class="fixed   w-full z-30 flex bg-white duration-500 dark:bg-[#0F172A] p-2 items-center justify-center h-16 px-10">
...
<div id="userDropdown" class="z-10 absolute ani ltr:right-0 rtl:left-0 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
  ...
  <div class="content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4">
    <nav class="flex px-5 py-3 text-gray-700 duration-500 rounded-lg bg-gray-50 dark:bg-[#1E293B] mb-5" aria-label="Breadcrumb">
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Subject</a>
          </div>
        </li>
      </ol>
    </nav>
